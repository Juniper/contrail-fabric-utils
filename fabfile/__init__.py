...
enable__testbed_file_validation = getattr(env,'enable__testbed_file_validation', False)
try:
    from tasks.verify_testbed import *
except ImportError:
    enable__testbed_file_validation = False

if enable__testbed_file_validation and env.tasks:
