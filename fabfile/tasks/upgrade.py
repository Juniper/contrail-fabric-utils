    ...
    for host_string in args:
        with settings(host_string=host_string):
            ...
            if ('vcenter_compute' in env.roledefs and 
                ...
                if LooseVersion(from_rel) <= LooseVersion('3.2.13.0'):
                    dist, version, extra = get_linux_distro()
                    if version == '14.04':
                       ...
                       if 'contrail-vrouter-3.13.0-142-generic' in pkgs:
                       ...
                       if 'contrail-vrouter-3.13.0-170-generic' in pkgs:
                          pkgs.remove('contrail-vrouter-3.13.0-170-generic')
                       pkgs.append('contrail-vrouter-3.13.0-170-generic')
