...
UBUNTU_R1_21_TO_R3_0 = copy.deepcopy(UBUNTU_R1_20_TO_R2_10)
...
UBUNTU_R1_30_TO_R3_0['cfgm']['backup_files'] += ['/etc/contrail/contrail-svc-monitor.conf',
...
UBUNTU_R2_0_TO_R3_0['database']['rename_files'].remove(('/etc/contrail/contrail-nodemgr-database.conf',
                                                        '/etc/contrail/contrail-database-nodemgr.conf'))
UBUNTU_R2_0_TO_R3_0['control']['backup_files'].remove('/etc/contrail/dns.conf')
UBUNTU_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns.conf',
                                                        '/etc/contrail/contrail-dns.conf'))
UBUNTU_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns/named.conf',
                                                        '/etc/contrail/dns/contrail-named.conf'))
UBUNTU_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns/rndc.conf',
                                                        '/etc/contrail/dns/contrail-rndc.conf'))
UBUNTU_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns/named.pid',
                                                        '/etc/contrail/dns/contrail-named.pid'))
UBUNTU_R3_0_TO_R3_0 = copy.deepcopy(UBUNTU_R2_0_TO_R3_0)
...
CENTOS_R1_10_TO_R3_0['cfgm']['rename_files'].append((
...
CENTOS_R1_20_TO_R3_0 = copy.deepcopy(CENTOS_R1_10_TO_R3_0)
CENTOS_R1_21_TO_R3_0 = copy.deepcopy(CENTOS_R1_20_TO_R3_0)
...
CENTOS_R2_0_TO_R3_0['database']['rename_files'].remove(('/etc/contrail/contrail-nodemgr-database.conf',
                                                        '/etc/contrail/contrail-database-nodemgr.conf'))
CENTOS_R2_0_TO_R3_0['control']['backup_files'].remove('/etc/contrail/dns.conf')
CENTOS_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns.conf',
                                                        '/etc/contrail/contrail-dns.conf'))
CENTOS_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns/named.conf',
                                                        '/etc/contrail/dns/contrail-named.conf'))
CENTOS_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns/rndc.conf',
                                                        '/etc/contrail/dns/contrail-rndc.conf'))
CENTOS_R2_0_TO_R3_0['control']['rename_files'].remove(('/etc/contrail/dns/named.pid',
                                                        '/etc/contrail/dns/contrail-named.pid'))
