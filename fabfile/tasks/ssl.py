...
def setup_discovery_ssl_certs_node(*nodes):
    default_certfile = '/etc/contrail/ssl/certs/server.pem'
    default_keyfile = '/etc/contrail/ssl/private/server-privkey.pem'
    default_cafile = '/etc/contrail/ssl/certs/ca-cert.pem'
