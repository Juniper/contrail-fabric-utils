...
esxi_hosts = {
    'esxi_host1' : {
          ...
          'contrail_vm' : {
               ...
               'host' : host2,
               'vmdk' : '/cs-shared-test/images/ContrailVM-disk1.vmdk'
          }
    }
}

'''
'contrailvm_ip' : '10.204.217.180',
'domain' : 'englab.juniper.net',
'password' : 'c0ntrail123',
'esx_ntp_server' : nodea22,
'''
# Folder where you have checked out the field-test git repo
env.test_repo_dir = '/homes/sunilbasker/esx-work/contrail-test'
env.mail_to = 'sunilbasker@juniper.net'
env.mail_server = '10.204.216.49'
env.mail_port = '25'
env.log_scenario = 'Ubuntu 12.04.3 - 2477~havana ESX Sanity'
