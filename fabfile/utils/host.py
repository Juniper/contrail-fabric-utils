...
def get_vcenter_ip(vcenter_info):
    for k in vcenter_info.keys():
        return get_from_vcenter_dict(k,'server', None)

def get_vcenter_port(vcenter_info):
    for k in vcenter_info.keys():
        return get_from_vcenter_dict(k,'port', None)

def get_vcenter_username(vcenter_info):
    for k in vcenter_info.keys():
        return get_from_vcenter_dict(k, 'username', None)

def get_vcenter_password(vcenter_info):
    for k in vcenter_info.keys():
        return get_from_vcenter_dict(k, 'password', None)

def get_vcenter_datacenter(vcenter_info):
    for k in vcenter_info.keys():
        return get_from_vcenter_dict(k, 'datacenter', None)

def get_vcenter_compute(vcenter_info):
    for k in vcenter_info.keys():
...
def get_authserver_protocol():
    orch = getattr(env, 'orchestrator', 'openstack')
    if orch == 'vcenter':
       for k in env.vcenter_serversi.keys():
